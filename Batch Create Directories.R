...
participant <- c("CI200","CI201","CI202","CI203","CI204","CI205","CI206","CI207","CI208","CI209","CI210",
                 "CI211","CI212","CI213","CI214","CI215","CI216","CI217","CI218","CI219","CI220","CI221","CI222")
# name <- c("Adamson")
...
for(p in 1:length(participant)){
  for(d in 1:length(date)){
    ...
    # }
    # if(!dir.exists(paste0(path,"/",surgeryDate,"- surgery"))){
